...
#    Updated: 2022/11/12 18:01:47 by emcnab           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# .c files
define CFILES
	ft_runner_create.c	ft_run_tests.c		ft_runner_success.c	ft_test_cequal.c
	...
	ft_free_all.c		ft_test_nequal.c	ft_test_nstrequal.c	ft_test_ncequal.c
endef
